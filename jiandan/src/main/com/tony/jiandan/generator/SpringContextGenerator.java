...
public class SpringContextGenerator implements Generator {

	Logger log = LoggerFactory.getLogger(SpringContextGenerator.class);
	...
	public File generate(Model model, String path) {
		...
		Template temp = null;
		try {
			temp = cfg.getTemplate("applicationContext.ftl");
		} catch (IOException e) {
			log.error(e.getLocalizedMessage());
		}

		final File file = new File(path + "/spring/applicationContext.xml");
